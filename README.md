...
- **Levels**: use integers `1` to `5` (1 = foundational, 5 = most advanced).
...
- **Quality bar**: use clear wordplay (ダジャレ), avoid repetitive templates, keep Japanese natural
  (no long English phrases embedded), and allow multi-sentence English if it reads cleanly.
